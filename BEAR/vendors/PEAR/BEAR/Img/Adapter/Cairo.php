 ...
 * @version   SVN: Release: $Id: Cairo.php 1257 2009-12-07 10:42:19Z koriyama@users.sourceforge.jp $
...
class BEAR_Img_Adapter_Cairo extends BEAR_Img_Adapter
{
     ...
     *
     */
    function addText($text, $x = 0, $y = 0, $size = 120, $align = BEAR_Img::LEFT, $colorOne = false, $colorTwo = false, $font = 'Arial', $textAlpha = 0.85, $lineWidth = 0.75, $slant = CAIRO_FONT_SLANT_NORMAL, $weight = CAIRO_FONT_WEIGHT_NORMAL)
    {
        //フォントカラー
