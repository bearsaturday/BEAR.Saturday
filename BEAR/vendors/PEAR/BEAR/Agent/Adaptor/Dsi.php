 ...
 * @abstract
 *  */
class BEAR_Agent_Adaptor_Dsi extends BEAR_Agent_Adaptor_Mobile implements BEAR_Agent_Adaptor_Interface
{
    /**
     * コンストラクタ
     *
    ...
    public function __construct(array $config)
    {
        ...
        $this->_config['role'] = array('Dsi', BEAR_Agent::UA_MOBILE, BEAR_Agent::UA_DEFAULT);
    }
}