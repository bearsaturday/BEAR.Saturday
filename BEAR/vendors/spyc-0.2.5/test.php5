...
if ($yaml['databases'] != array(
    array("name" => "spartan", 
        "notes" => array("Needs to be backed up", "Needs to be normalized"), 
        "type" => "mysql")))
...
if ($yaml[10] != array("name" => "mark", "age" => "older than chris", "brand" => array("marlboro", "lucky strike")))
...
if ($yaml['all languages'] != array(array('Perl', 'Python', 'PHP', 'Ruby'), array('C/C++', 'Java')))
